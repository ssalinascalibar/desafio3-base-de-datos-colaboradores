...
function App() {
  ...
  const enviarFormulario = (e) => {
    e.preventDefault() //detiene ejecución de los eventos al usar submit, ya que debería enviar la info a un servidor, si esto no está no se verían los cambios
    console.log('enviando formulario');
    setColaboradores([...colaboradores, {nombre:nuevoColaborador, correo:emailColaborador}]); //con [...colaboradores] se hace una copia de ese arreglo para agregarle el nuevo objeto con sus porpiedades
    
    setNuevoColaborador(''); // limpia el input de nuevo colaborador
    setEmailColaborador(''); // limpia el input del email del colaborador
  }
